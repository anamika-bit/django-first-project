...
class User(AbstractBaseUser):
    ...
    business_type = models.CharField(max_length = 10, choices = BUSINESS_CHOICES, default = 'Individual')
    phone = models.CharField(max_length = 10, validators=[MinLengthValidator(10)], default = '8899776655')
    address = models.CharField(max_length = 30, default = 'sector-7, Rose street')
    ...
    country_code = models.CharField(max_length = 3,validators=[MinLengthValidator(3)], default = '+91')
